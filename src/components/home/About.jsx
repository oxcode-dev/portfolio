            ...
            <div id='about' className='min-h-screen relative group'>
                ...
                <div className='container mx-auto flex flex-wrap items-center px-6 sm:px-8 md:px-16 py-24'>
                    ...
                    <div className='w-full md:w-1/2'>
                        ...
                        <div class="mt-8 md:pl-4">
                            <a class="inline-flex items-baseline leading-tight font-semibold text-slate-200 group group/link text-lg" href="/resume.pdf" target="_blank" rel="noreferrer noopener" aria-label="View Full Résumé (opens in a new tab)">
