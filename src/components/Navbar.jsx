...
export const NavBar = () => {
    ...
    return (
        <>
            <div className={`fixed w-full z-50 bg-[${isDarkMode ? '#060801' : 'white'}]`}>
                <div className="w-full md:container mx-auto flex justify-between items-start py-8 md:px-6 px-4 pr-6">
                    <div>
                        <Logo />
                    </div>
                    <div className="inline-flex space-x-3 items-center">
                        <a className="mr-2 text-white" href="#" onClick={e => toggleDarkMode(e) }>
                        ...
                        <a className="mr-2" href="#" onClick={e => toggleNavs(e) }>
                            <svg className="text-white" width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="2.5" cy="2.5" r="2.5" fill="currentColor"/><circle cx="14" cy="2.5" r="2.5" fill="currentColor"/><circle cx="2.5" cy="14" r="2.5" fill="currentColor"/><circle cx="14" cy="14" r="2.5" fill="currentColor"/></svg>
                        </a>
                    </div>
                </div>
            </div>
